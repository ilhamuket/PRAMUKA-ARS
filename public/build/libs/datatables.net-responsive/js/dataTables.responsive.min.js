...
*/
    (function (d) {
        ...
        function r(a, b, c) {
            var e = b + "-" + c;
            if (n[e]) {
                for (var a = a.cell(b, c).node(), c = n[e][0].parentNode.childNodes,
                b =[],
                d = 0,
                g = c.length; d < g; d++) 
                    b.push(c[d]);
        ...
        d.extend(
            ...
            _constructor: function () {
                ...
                c.oApi._fnCallbackReg(c, "aoRowCreatedCallback", function (c) {
                    -1 !== d.inArray(!1, a.s.current) && d(">td, >th", c).each(function (c) {
            ...
            _resize : function (a) {
                ...
                var l = !1,
                    n = 0;
                c.columns().eq(0).each(function (c, d) {
                    !0 === k[d] && n++;
                    if (a || k[d] !== i[d]) 
                        l = !0,
                        b._setColumnVis(c, k[d])
        ...
        i.renderer = {
            listHiddenNodes: function () {
                return function (a, b, c) {
                    ...
                    ) + ' data-dtr-index="' + c.columnIndex + '" data-dt-row="' + c.rowIndex + '" data-dt-column="' + c.columnIndex + '"><span class="dtr-title">' + c.title + "</span> </li>").append(d('<span class="dtr-data"/>').append(t(a, c.rowIndex, c.columnIndex))).appendTo(e), f =! 0)
                    });
                    return f ? e : !1
                }
            },
            ...
            tableAll: function (a) {
                ...
                return function (b, c, e) {
                    ...
                    ) + ' data-dt-row="' + a.rowIndex + '" data-dt-column="' + a.columnIndex + '"><td>' + a.title + ":</td> <td>" + a.data + "</td></tr>"
                    }).join("");
